...
final class ConversionTests: XCTestCase {
    ...
    func testTranspose() {
        do{
            ...
            XCTAssertEqual(a.T, MfArray<Int>([[3, -22],
                                              [-19, 4]]))
            
            XCTAssertEqual(b.T, MfArray<Int>([[2, 5],
                                              [1177, -43]]))
        }
        ...
        do{
            ...
            XCTAssertEqual(a.T, MfArray<Double>([[2, 3],
                                                 [1, 1],
                                                 [-3, 4],
                                                 [0, -5]]))
            XCTAssertEqual(b.transpose(), MfArray<Double>([[-0.87, -0.0002],
                                                           [1.2, 2],
                                                           [5.5134, 3.4],
                                                           [-8.78, -5]]))
        ...
        do{
            ...
            XCTAssertEqual(a.transpose(axes: [0, 2, 3, 1]), MfArray<Int>([[[[ 0,  4],
                                                                            [ 1,  5]],
                                                                          ...
                                                                          [[[ 8, 12],
                                                                           ...
                                                                           [[10, 14],
                                                                            [11, 15]]]]))
            XCTAssertEqual(a.transpose(axes: [3,0,2,1]), MfArray<Int>([[[[ 0,  4],
                                                                         [ 2,  6]],
    ...
    func testMoveaxis() {
        do{
            ...
            XCTAssertEqual(a.moveaxis(src: 0, dst: 1), MfArray<Int>([[3, -22],
                                                                     [-19, 4]]))
            XCTAssertEqual(a.moveaxis(src: -1, dst: -2), MfArray<Int>([[3, -22],
                                                                       [-19, 4]]))
            
            XCTAssertEqual(b.moveaxis(src: 0, dst: 1), MfArray<Int>([[2, 5],
                                                                     [1177, -43]]))
    ...
    func testSort(){
        do{
            let a = MfArray<Int>([[2, -7, 0],
                                  [1, 5, -2]])
            XCTAssertEqual(a.sort(axis: nil), MfArray<Int>([-7, -2,  0,  1,  2,  5]))
            XCTAssertEqual(a.sort(axis: -1), MfArray<Int>([[-7,  0,  2],
                                                           [-2,  1,  5]]))
        ...
        do{
            ...
            XCTAssertEqual(a.sort(), MfArray<Double>([[-8.7800e+00, -8.7000e-01,  1.2000e+00,  5.5134e+00],
    ...
    func testArgSort(){
        do{
            let a = MfArray<Int>([[2, -7, 0],
                                  [1, 5, -2]])
            XCTAssertEqual(a.argsort(axis: nil), MfArray<Int>([1, 5, 2, 3, 0, 4]))
            XCTAssertEqual(a.argsort(axis: -1), MfArray<Int>([[1, 2, 0],
                                                              [2, 0, 1]]))
            XCTAssertEqual(a.argsort(axis: 0), MfArray<Int>([[1, 0, 1],
                                                             [0, 1, 0]]))
        }
        ...
        do{
            let a = MfArray<Double>([[-0.87, 1.2, 5.5134, -8.78],
                                     [-0.0002, 2, 3.4, -5]], mforder: .Column)
            XCTAssertEqual(a.argsort(axis: nil, order: .Descending), MfArray<Int>([2, 6, 5, 1, 4, 0, 7, 3]))
            XCTAssertEqual(a.argsort(axis: -1, order: .Descending), MfArray<Int>([[2, 1, 0, 3],
                                                                                     [2, 1, 0, 3]]))
            XCTAssertEqual(a.argsort(), MfArray<Int>([[3, 0, 1, 2],
                                                         [3, 0, 1, 2]]))
        }
    }
    ...
    func testClip(){
        do{
            let a = MfArray<Int>([[2, -7, 0],
                                  [1, 5, -2]])
            XCTAssertEqual(a.clip(min: -3, max: 3), MfArray<Int>([[2, -3, 0],
                                                                  [1, 3, -2]]))
            XCTAssertEqual(a.clip(min: -1), MfArray<Int>([[2, -1, 0],
                                                          [1, 5, -1]]))
            XCTAssertEqual(a.clip(max: 0), MfArray<Int>([[0, -7, 0],
                                                         [0, 0, -2]]))
        }
        ...
        do{
            let a = MfArray<Double>([[-0.87, 1.2, 5.5134, -8.78],
                                     [-0.0002, 2, 3.4, -5]], mforder: .Column)
            XCTAssertEqual(a.clip(min: -0.2, max: 1.2), MfArray<Double>([[-0.2, 1.2, 1.2, -0.2],
                                                                         [-0.0002, 1.2, 1.2, -0.2]]))
            XCTAssertEqual(a.clip(max: 1.2), MfArray<Double>([[-0.87, 1.2, 1.2, -8.78],
                                                              [-0.0002, 1.2, 1.2, -5]]))
            XCTAssertEqual(a.clip(min: -0.2), MfArray<Double>([[-0.2, 1.2, 5.5134, -0.2],
                                                               [-0.0002, 2, 3.4, -0.2]]))
        }
    }
    ...
    func testReshape(){
        do{
            let a = MfArray<Float>([2.0, 1.1, 3.2, 2.5])
        ...
        do{
            ...
            XCTAssertEqual(a.reshape([2, 3, 3, 2]), MfArray<Int>([[[[ 0,  1],
                                                               [ 2,  3],
                                                               [ 4,  5]],
        ...
        do{
            ...
            XCTAssertEqual(a.reshape([3, 1, 2]), MfArray<Int>([[[ 1,  3]],
