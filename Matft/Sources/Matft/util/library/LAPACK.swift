...
internal func solve_by_lapack<T>(copiedCoefPtr: UnsafeMutablePointer<T>, _ eqNum: Int, _ dstptr: UnsafeMutablePointer<T>, _ dstColNum: Int, _ lapack_solve_func: lapack_solve<T>) throws {
